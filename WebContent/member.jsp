...
<body>
    <h2>회원가입</h2>
    <form action="member_ok.jsp" name="regform" id="regform" onsubmit="return sendit()">
        ...
        <p>
            우편번호: <input type="text" id="sample6_postcode" name="zipcode" maxlength="5"><button type="button" onclick="sample6_execDaumPostcode()">검색</button>
        </p>
        ...
        <p><button>가입 완료</button><button type="reset">다시 작성 </button></p>
    </form>
